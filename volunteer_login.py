              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav nav-item dropdown d-flex justify-content-center align-items-center my-lg-0 my-4">
                  ...
                  <ul class="dropdown-menu dropdown-menu-lg-end" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="#">Volunteer Login</a></li>
    ...
    <div class="row">
      ...
      <div class="col-lg-6 p-5 frmdetails">
            <div class="title my-5">
               <h2 class="text-center">Volunteer Login</h2>
            </div>
            <div class="form">
              <form action="" name="stulog" onsubmit="return checkallforlog() method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="password" style="text-transform:capitalize;" class="form-control" id="pass" name="pass">
                </div>
...
admpass="12345678"
if Sub!=None:
    q="""select id from volunteers where fullname="%s" """ %(Password)
    cur.execute(q)
    res=cur.fetchone()
    ...
    if res!=None and Username=='volunteer':
        print("""
        <script>
            alert("Login Success");
            location.href="volunteerdashboard.py?id=%s";
        </script>""" %res[0])
    else:
        print("""
        <script>
