...
print("""
       ...
       <head>
            ...
            /*approve reject button responsive*/
            
            
            @media screen and (min-width:320px) and (max-width:636px){
                #eventslist .container-fluid .neweventdetails table .ar{
            ...
            <div class="row m-0" style="height:90vh;width:100%;border:2px solid;border-color: #f9f9f9;">
                    ...
                    <!-- dashmenus -->
                        ...
                        <div class="row dashmenus my-4">
                            <ul class="nav navbar-nav py-4" style="padding-right: 0px;">
                                ...
                                <li class="nav-item my-2">
                                    <a id="Events" href="#" class="nav-link text-center" style="font-weight: 700;background-color: black;color: #eeeeee ;">Events</a>
                                </li>
                ...
                <section id="eventslist">
                            <div class="container-fluid p-0">
                                <div class="row-12">
                                    <h2 style="background-color:#F50057;color:white;text-transform:uppercase;font-weight:700;font-size:25px;" class="text-center m-0">New Events</h2>
                                    <div class="neweventdetails">
...
q="""select * from eventdetails where status='' """
cur.execute(q)
rec=cur.fetchall()
for i in rec:
    print("""
                                          <tr>
                                              <form method="post">
                                              <td><input type="text" value="%s" name="id" readonly style="width:25px;border:none"></td>
                                              ...
                                              <td style="text-transform:capitalize;">%s</td>
                                              <td style="text-transform:capitalize;">%s</td>
                                              <td style="display:flex;align-items:center;justify-content:center;flex-direction:column">
                                              <input type="submit" class="btn btn-success ar" style="width:100px;height:30px;font-size:10px;" name="app" value="Approved"><br><br>
                                                <input type="submit" class="btn btn-danger ar" style="width:100px;height:30px;font-size:10px;" name="rej" value="Reject">  
                                              </td>
                                              </form>
...
if App!=None:
    q="""update eventdetails set status='Approved' WHERE id='%s' """%(pid)
    cur.execute(q)
    conn.commit()
elif Rej!=None:
    q="""delete from eventdetails WHERE id='%s' """%(pid)
    cur.execute(q)
    conn.commit()
...
print("""
                                ...
                                <div class="row-12">
                                    <h2 style="background-color:#F50057;color:white;text-transform:uppercase;font-weight:700;font-size:25px;" class="text-center m-0">Existing Events</h2>
                                    <div class="existeventdetails">
                                        <table class="table table-bordered" id="deltab">
                                        <thead>
                                          <tr>
                                            <th scope="col" style="color:#F50057 !important">Id</th>
