              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav nav-item dropdown d-flex justify-content-center align-items-center my-lg-0 my-4">
                  ...
                  <ul class="dropdown-menu dropdown-menu-lg-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="#">Sports Faculty Login</a></li>
    ...
    <div class="row">
      ...
      <div class="col-lg-6 p-5 frmdetails">
            <div class="title my-5">
               <h2 class="text-center">Sportsfaculty Login</h2>
            </div>
            <div class="form">
...
admpass="12345678"
if Sub!=None:
    q="""select id from spfaculty where fullname="%s" """ %(Password)
    cur.execute(q)
    res=cur.fetchone()
    ...
    if res!=None and Username=='sportshead':
        print("""
        <script>
            alert("Login Success");
            location.href="spfm_addevent.py";
        </script>""")
    else:
        print("""
        <script>
