...
q="""select * from volunteers where id='%s' """%pid
cur.execute(q)
rec=cur.fetchone()
print("""
       <!DOCTYPE html>
                ...
                <div class="col-lg-3 col-12 userdetails" style="background-color: #F50057 !important;">
                    ...
                    <!-- profile -->
                        ...
                        <div class="row profile d-flex justify-content-center align-items-center text-center">
                            <span class="my-3 d-flex justify-content-center align-items-center" style="color:#f9f9f9;width:100px;height:100px;font-size: 50px;border-radius: 50%;background-color: #FF4081;">V</span>
                            <h2 style="color:white;font-weight: 600;">Hii</h2>""")
print("""
                            <h3 style="color:#eeeeee;text-transform:capitalize;">%s</h3>
                        </div>
                        ...
                        <div class="row dashmenus my-4">
                            <ul class="nav navbar-nav py-4" style="padding-right: 0px;">
                                ...
                                <li class="nav-item my-2">
                                    <a onclick="return arrangements()" id="arrange" href="#arrangements" class="nav-link text-center" style="font-weight: 700;background-color: #eeeeee;color: #F50057 ;">Arrangements</a>
                                </li>
                ...
                <div class="col-lg-9 col-12 definitions p-0">
                    <section class="right p-5" id="editprofile" style="display: block;">
                            <form action="" name="volunteersform"  method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                  <label for="fullname" class="form-label" style="font-weight:600;">Full Name</label>
                                  <input type="text" class="form-control" style="text-transform:capitalize;" id="fullname" name="fname" value=%s>
                                </div>
                                <div class="mb-3">
                                  <label for="email" class="form-label" style="font-weight:600;">Email</label>
                                  <input type="email" class="form-control" style="text-transform:lowercase;" id="email" name="email" value=%s>
                                </div>
                                <div class="mb-3">
                                  <label for="pnumbar" class="form-label" style="font-weight:600;">Phone Number</label>
                                  <input type="text" class="form-control" id="pnumber" name="pnumber" value=%s>
                                </div>
...
print("""
                    ...
                    <section id="arrangements" style="display:none;">
...
for i in rec:
    print("""
                                          <tr>
                                              ...
                                              <td style="text-transform:capitalize;">%s</td>
                                              <td style="text-transform:capitalize;">%s</td>
                                          </tr>"""%(i[2],i[3],i[4],i[5],i[6],i[7],i[8]))
...
print("""
    ...
    <script >
        function editprofile(){
            ...
            document.getElementById("arrange").style="background-color:#eeeeee;color:#F50057;font-weight:700;"
        }
        function arrangements(){
            document.getElementById("arrangements").style="display:block;"
            document.getElementById("editprofile").style="display:none"
            document.getElementById("arrange").style="background-color:black;color:#eeeeee;font-weight:700;"
...
if Sub!=None:
    q="""UPDATE `volunteers` SET `fullname`='%s',`email`='%s',`phonenumber`='%s' WHERE id='%s' """%(Fname,Email,Pnumber,pid)
    cur.execute(q)
    conn.commit()
    print("""
    <script>
